                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="sname"
                                                    placeholder="Supplier Name Here" name="sname" value="<?php echo $dataRow['supplier_name']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="saname"
                                                    placeholder="Supplier Address Here" name="saname" value="<?php echo $dataRow['supplier_address']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <form class="form-horizontal" method="post" action="functions/addSupplier.php">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="sname"
                                                    placeholder="Supplier Name Here" name="sname">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="lname" class="col-sm-3 text-end control-label col-form-label">Supplier Address</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="saname"
                                                    placeholder="Supplier Address Here" name="saname">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="border-top">
