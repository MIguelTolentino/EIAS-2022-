                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="iname"
                                                placeholder="Item name" name="iname">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname"
                                        ...
                                        <div class="col-sm-9">
                                            <textarea type="text" class="form-control" id="iname"
                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            ?>                                                        
                                            <?php 
                                            $query = "SELECT * FROM `tbl_items` INNER JOIN tbl_location ON tbl_items.location_id=tbl_location.location_id INNER JOIN tbl_category ON tbl_items.category_id = tbl_category.category_id INNER JOIN tbl_brands ON tbl_items.brand_id = tbl_brands.brand_id";
                                            $result = $con->query($query);
                                            $no = 1;
                                            while($row = $result->fetch_assoc()){
                                                ?>
                                                <tr>
                                                    ...
                                                    <td><button type="button" class="btn btn-warning btn-sm text-white updateStatus" data-toggle="modal" data-target="#exampleModalCenter" data-id="<?php echo $row['item_id']; ?>">Update</button></td>
                                                </tr>
                                                <?php
                                                $no++;
                                            }
