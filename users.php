                                        ...
                                        <tbody>
                                            ...
                                            while($row = $result->fetch_assoc()){
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="users.php?userid=<?php echo $row['user_id']; ?>">Edit</a> | <a href="functions/deleteUser.php?userid=<?php echo $row['user_id']; ?>">Delete</a></td>
                                                </tr>
                                                <?php
                                            }
                                            ?>
