<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
        ...
        <!-- Brand -->
            <h1 class="EIAS">EIAS</h1>       
        <!-- User -->
        <ul class="nav align-items-center d-md-none">x`
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="#navbar-transaction" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="navbar-transaction">
                        <i class="fas fa-exchange-alt" style="color: #f4645f;"></i>
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="#navbar-maintenance" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="navbar-maintenance">
                        <i class="fa fa-box" style="color: #f4645f;"></i>
